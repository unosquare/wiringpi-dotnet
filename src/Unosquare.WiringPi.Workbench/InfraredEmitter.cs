namespace Unosquare.RaspberryIO.Peripherals
{
    ...
    public sealed class InfraredEmitter
    {
        ...
        public static class NecEncoder
        {
            ...
            private static readonly InfraredSensor.InfraredPulse[] RepeatPulses = {
                PreambleMark,
                RepeatSpace,
                ShortMark,
            };

            private static readonly InfraredSensor.InfraredPulse[] PreambleData = {
                PreambleMark,
                DataSpace,
            };

            private static readonly InfraredSensor.InfraredPulse[] V0 = {
                ShortMark,
                ShortSpace,
            };

            private static readonly InfraredSensor.InfraredPulse[] V1 = {
                ShortMark,
                LongSpace,
            };
